...
from multinet.api.utils.workspace_permissions import *
from guardian.shortcuts import get_user_perms
from typing import Any

def require_permissions(minimum_permission: str) -> Any:
    """
    Decorate an API endpoint to check for object permissions. Returns Http403 if the request's user does not have appropriate permissions.
    """
    def require_permissions_inner(func: Any) -> Any:
