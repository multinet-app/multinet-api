...
def ensure_arangodb_collection_exists(sender, instance: Workspace, *args, **kwargs):
    ensure_db_created(instance.arango_db_name)


@receiver(pre_delete, sender=Workspace)
def ensure_arangodb_collection_deleted(sender, instance: Workspace, *args, **kwargs):
